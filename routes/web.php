...
Route::get('/show-truck', [TruckController::class, 'truckDriver'])->name('show-truck');
Route::get('/show-truck-location/{truck_id}', [TruckController::class, 'showUserLocation'])->name('show.truck.location');
