            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            <h4 class="mt-0 header-title">Customer Pricing ({{$customerPricing->customer->business_name}})</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="collawnmowersatvmotorcycle" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="lawnmowers_atvmotorcycle" type="number" step="0.01" class="form-control"
                                        ...
                                        <div id="colpassanger_lighttruck" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="passanger_lighttruck" type="number" step="0.01" class="form-control"
                                        ...
                                        <div id="colpassanger_lighttruckwithrim" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="passanger_lighttruckwithrim" type="number" step="0.01" class="form-control"
                                        ...
                                        <div id="colsemitruck" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="semi_truck" type="number" step="0.01" class="form-control" name="semi_truck"
                                        ...
                                        <div id="colsemisupersingles" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="semi_super_singles" type="number" step="0.01" class="form-control"
                                        ...
                                        <div id="colsemitruckwithrim" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="semi_truck_with_rim" type="number" step="0.01" class="form-control"
                                        ...
                                        <div id="colag_med_truck_19_5_skid_steer" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="ag_med_truck_19_5_skid_steer" type="number" step="0.01" class="form-control"
                                        ...
                                        <div id="colag_med_truck_19_5_with_rim" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="ag_med_truck_19_5_with_rim" type="number" step="0.01" class="form-control"
                                        ...
                                        <div id="colfarm_tractor_last_two_digits" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="farm_tractor_last_two_digits" type="number" step="0.01" class="form-control"
                                        ...
                                        <div id="" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="price_per_ton" type="number" step="0.01" class="form-control" name="price_per_ton"
                                        ...
                                        <div id="" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="price_per_lb" type="number" step="0.01" class="form-control" name="price_per_lb"
                                        ...
                                        <div id="" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="" type="number" step="0.01" class="form-control" name="swap_total"
                                        ...
                                        <div id="" class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input id="" type="number" step="0.01" class="form-control" name="per_metric_ton"
