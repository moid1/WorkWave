                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="business_name" type="text"
                                                    ...
                                                    name="business_name" value="{{ old('business_name') }}" autofocus>
                                                @error('business_name')
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="poc_name" type="text"
                                                    ...
                                                    name="poc_name" value="{{ old('poc_name') }}" autofocus>
                                                @error('poc_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="mail_phone" type="text"
                                                    ...
                                                    name="mail_phone" value="{{ old('mail_phone') }}">
                                                @error('mail_phone')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="second_mail" type="text"
                                                    ...
                                                    name="second_mail" value="{{ old('second_mail') }}"
                                                    autocomplete="email">
                                                @error('second_mail')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="convenienceFee" step="0.1" type="number"
                                                    ...
                                                    name="convenienceFee" value="{{ old('convenienceFee') }}"
                                                    autocomplete="email">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="earlierPT" type="time"
                                                    ...
                                                    name="earlierPT" value="{{ old('earlierPT') }}"
                                                    autocomplete="email">
                                                @error('earlierPT')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="po" type="text"
                                                    ...
                                                    value="{{ old('po') }}" autocomplete="email">
                                                @error('po')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select id="" name="trailer_grading_type"
                                                    class="form-control form-select form-select-lg mb-3"
                                                    aria-label=".form-select-lg example">
