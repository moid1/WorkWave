                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            ...
                            @if(Auth::user()->type == '1')
                                <span class="text-muted user-status"><i class="fa fa-dot-circle-o text-success"></i> Manager</span>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            @if(Auth::user()->type == 0)
                                <li>
                                    <a href="{{ route('register.manager') }}" class="waves-effect"><i class="mdi mdi-buffer"></i> <span> Manager Creation </span></a>
                                </li>
                                <li>
                            ...
                            @if(Auth::user()->type == 0 || Auth::user()->type == 1)
                                <li class="has_sub">
                                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-buffer"></i> <span> CX Creation </span></a>
                                    <ul class="list-unstyled">
                                ...
                                <li class="has_sub">
                                    <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-buffer"></i> <span> Orders </span><i class="fa fa-caret-down" style="margin-left:20px; " aria-hidden="true"></i>
                                    </a>
                                    <ul class="list-unstyled">
                            ...
                            @if(Auth::user()->type == 2)
                            <li>
                                <a href="{{route('order.driver.index')}}" class="waves-effect"><i class="mdi mdi-calendar-check"></i><span> Assigned Orders </span></a>
                            </li>
                            @endif
                        </ul>
                    </div>
                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                        <a class="dropdown-item" href="{{route('change-password')}}"><i class="mdi mdi-account-circle m-r-5 text-muted"></i> Change Password</a>
