...
<body>
                        ...
                        <table class="table table-borderless table-sm">
                            <tbody>
                                ...
                                <tr>
                                    <div class="d-flex flex-column">
                                        <span class="inputField"
                                            style="display: inline-block;">6200988</span>
                                ...
                                <tr>
                                    <td>
                                        <div style="display: inline-block">
                                            ...
                                            <label class="inputLabel" style="white-space: nowrap">Area Code
                                                Telephone
                                                Number</label>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <div class="d-flex flex-column">
                                        <input type="text" name=""
                                            value="RELIABLE TIRE DISPOSAL" class="inputField" />
                                    ...
                                    <td style="justify-content:left">
                                        <div style="display: inline-flex;width:200px;">
                                            <span style="display: inline-block;height:20px"
                                                class="inputField">Anetra Thomas</span>
                                            <label class="inputLabel" style="white-space: nowrap">Contact
                                                Name</label>
                                        </div>

                                        <div style="display: inline-flex;width:200px;">
                                            <span style="display: inline-block;height:20px"
                                                class="inputField">512-756-8218</span>
                                ...
                                <tr>
                                    <div class="d-flex flex-column">
                                        <input type="text" name=""
                                            value="3345 E. State HWY 29 Burnet, TX 78611
                                            " class="inputField" />
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-sm">
                            <tbody>
                                ...
                                <tr>
                                    <span class="fw-bold "
                                        style="font-size: 0.88rem; line-height: normal;margin-top:5px">I certify
                                        that
        ...
        <table style="width: 100%">
            <tbody>
                ...
                <tr>
                    ...
                    <div>
                        <label class="inputLabel" style="margin-top: 10px; min-width: 160px;">to be
                            delivered:</label>
                        <input style="border-bottom: 1px solid #333;min-width:150px" type="number" name=""
                            value="" />
                        <label class="inputLabel">passenger tires</label>
                                ...
                                <tr>
                                    ...
                                    <div style="display: inline-flex;">
                                        <input type="text" name="" value="" style="min-width: 60px"
                                            class="inputField" />
                                        <label class="inputLabel" style="text-align: center">no. truck
                                            tires</label>
                                    </div>
                                    ...
                                    <div style="display: inline-flex;margin-left:5px">
                                        <input type="text" name="" value="" style="min-width: 60px;"
                                            class="inputField" />
                                        <label class="inputLabel" style="text-align: center">weight of
                                            tires</label>
                                    </div>
                        ...
                        <tbody>
                            <td>
                                ...
                                <tr class="mt-2" style="">
                                    ...
                                    <div style="display: inline-flex;max-width:150px;">
                                        <input type="text" name=""
                                            value="{{ $data->order->customer->company_registration ?? 'N/A' }}"
                                            class="inputField" />
                                        <label class="inputLabel">registration number</label>
                                    </div>
                                    ...
                                    <div style="display: inline-flex;">
                                        <input type="text" name="" value="{{$currentTime}}" style="min-width: 200px"
                                            class="inputField" />
                                        <label class="inputLabel" style="text-align: center">date and time of
                                            pickup</label>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <p class="fw-bold" style="margin-top: 7px;display: inline-flex;">OR</p>
                                    <div style="display: inline-flex;margin-left:5px">
                                        <input type="text" name="" value="{{$data->tdf->total_weight_lbs}}" style="min-width: 60px;"
                                            class="inputField" />
                                        <label class="inputLabel" style="text-align: center">weight of
                                            tires</label>
                                    </div>
    ...
    @foreach ($data['todaysOrder'] as $todayOrder)
        <table class="table table-borderless">
            <tbody>
                <tr>
                    <td style="width: 50%">
                            ...
                            <table class="table table-borderless table-sm">
                                <tbody>
                                    ...
                                    <tr>
                                        <div class="d-flex flex-column">
                                            <span class="inputField"
                                                style="display: inline-block;">{{ $todayOrder->customer->company_registration }}</span>
                                            <label class="inputLabel">Registration Number/Type of Generator</label>
                                        </div>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div style="display: inline-block">
                                                <input type="text" name=""
                                                    value="{{ $todayOrder->customer->phone_no }}"
                                                    class="inputField" />
                                                <label class="inputLabel" style="white-space: nowrap">Area Code
                                                    Telephone
                                                    Number</label>
                                    ...
                                    <tr>
                                        <div class="d-flex flex-column">
                                            <input type="text" name=""
                                                value="{{ $todayOrder->customer->business_name }}"
                                                class="inputField" />
                                            <label class="inputLabel">Company Name</label>
                                        </div>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="justify-content:left">
                                            <div style="display: inline-flex;width:200px;">
                                                <span style="display: inline-block;height:20px"
                                                    class="inputField">{{ $todayOrder->customer->poc_name }}</span>
                                                <label class="inputLabel" style="white-space: nowrap">Contact
                                                    Name</label>
                                            </div>
                                            ...
                                            <div style="display: inline-flex;width:200px;">
                                                <span style="display: inline-block;height:20px"
                                                    class="inputField">{{ $todayOrder->customer->phone_no }}</span>
                                                <label class="inputLabel" style="white-space: nowrap">Contact
                                                    No</label>
                                            </div>
                                    ...
                                    <tr>
                                        <div class="d-flex flex-column">
                                            <input type="text" name=""
                                                value="{{ $todayOrder->customer->address }}" class="inputField" />
                                            <label class="inputLabel">Street Address</label>
                                        </div>
                                    </tr>
                                    ...
                                    @php
                                        if ($todayOrder->load_type == 'trailer_swap') {
                                            $totalSum = $data->customerPricing->swap_total;
                                        }
                                    @endphp
                                    @if ($todayOrder->load_type !== 'state')
                                        <tr style="text-align: right;">
                                            <!-- Total $ - 1 -->
                                            <div class="mt-2 ">
                                                <label class="inputLabel inputLabelSmall">Total $</label>
                                    ...
                                    @if ($todayOrder->load_type !== 'state')
                                        <tr style="text-align: right;">
                                            <div class="mt-2 ">
                                                <label class="inputLabel"
                                                    style="margin-top: 10px; min-width: 85px">Sales
                                                    Tax
                                                    $</label>
                                                <input type="text" name=""
                                                    value="{{ $todayOrder->customer->tax ?? 0 }}%"
                                                    style="background:none;border:none;border-bottom: 1px solid #333;max-width:55px;margin-right:5em;" />
                                            </div>
                                        </tr>
                                    @endif
                                    ...
                                    @php
                                        if ($todayOrder->load_type !== 'state') {
                                            $customerTax = $todayOrder->customer->tax ?? 0;
                                            $totalSumWithTax = 0;
                                            if ($customerTax == 0) {
                                                $totalSumWithTax = number_format($totalSum, 2);
                                            } else {
                            ...
                            <table class="table table-borderless table-sm">
                                <tbody>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div>
                                                <div class="d-flex felx-row gap-3">
                                                    <h3 class="text-center text-capiatlize fw-bold">
                                                        Whole Used or Scrap Tire Manifest <span
                                                            style="color: red">000{{ $todayOrder->id }}</span>
                                                    </h3>
                                                </div>
                                                <p class=" text-uppercase text-center "
                                                    style="font-size: 0.88rem; line-height: normal">
                                    ...
                                    <tr class="">
                                        ...
                                        <div style="margin-top:15px;display: inline-flex;width:250px;">
                                            <input type="text" name="" value="6200792 "
                                                class="inputField" />
                                            <label class="inputLabel">registration number</label>
                                        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <div>
                            <label class="inputLabel" style="margin-top: 10px; min-width: 160px;">No. of Tires Picked
                                Up:</label>
                            <input style="border-bottom: 1px solid #333;min-width:150px" type="number"
                                name="" value="" />
                            <label class="inputLabel">passenger tires</label>
                            ...
                            <tbody>
                                <td>
                                    ...
                                    <tr>
                                        ...
                                        <div style="display: inline-flex;">
                                            <input type="text" name="" value=""
                                                style="min-width: 60px" class="inputField" />
                                            <label class="inputLabel" style="text-align: center">no. truck
                                                tires</label>
                                        </div>
                                        <p class="fw-bold" style="margin-top: 7px;display: inline-flex;">OR</p>
                                    ...
                                    <tr>
                                        <td>
                                            <div style="display: inline-block">
                                                <input type="text" name=""
                                                    value="{{ $data->order->customer->phone_no }}"
                                                    class="inputField" />
                                                <label class="inputLabel" style="white-space: nowrap">Area Code
                                                    Telephone
                                                    Number</label>
                            ...
                            <tbody>
                                <td>
                                    ...
                                    <tr class="mt-2" style="">
                                        ...
                                        <div style="display: inline-flex;">
                                            <input type="text" name="" value=""
                                                style="min-width: 200px" class="inputField" />
                                            <label class="inputLabel" style="text-align: center">date and time of
                                                pickup</label>
                                        </div>
