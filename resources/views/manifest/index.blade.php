          ...
          <div class="table-responsive">
            <table class="table table-borderless table-sm">
              <tbody>
                ...
                <tr>
                  <div>
                    <label class="inputLabel" style="margin-top: 10px;width:140px ">No. Passenger tires</label>
                    <span
                      style="display:inline-block;background:none;border:none;border-bottom: 1px solid #333;width:120px">{{$data->no_of_passenger}}</span>


                    <label class="inputLabel inputLabelExtraSmall" style="width: 25px;">@ $</label>
                    <span
                    ...
                    $total_passenger_pricing = floatval($data->no_of_passenger) *
                    floatval($data->order->customer->passenger_pricing) ;
                    }
                    @endphp
                    <span
                ...
                @if($data->fulfilTyres->lawnmowers_atvmotorcycle)
                <tr>
                  <div>
                    <label class="inputLabel" style="margin-top: 10px;width:140px ">No.ATVMotorcycle</label>
                    <span
                      style="display:inline-block;background:none;border:none;border-bottom: 1px solid #333;width:120px">{{$data->fulfilTyres->lawnmowers_atvmotorcycle}}</span>
                ...
                <tr>
                  <div class="mt-2">
                    <label class="inputLabel" style="margin-top: 10px;width:140px; ">No. Truck tires</label>
                    <span
                      style="display:inline-block;background:none;border:none;border-bottom: 1px solid #333;width:120px">{{$data->no_of_truck_tyre}}</span>
                    ...
                    <label class="inputLabel inputLabelSmall">Total $</label>
                    <span
                      style="display:inline-block;background:none;border:none;border-bottom: 1px solid #333;width:50px">{{$data->order->customer->truck_pricing
                      * $data->no_of_truck_tyre}}</span>
                ...
                <tr>
                  <div class="mt-2">
                    <label class="inputLabel" style="margin-top: 10px; width:140px; ">No. Agri tires</label>

                    <span
                      style="display:inline-block;background:none;border:none;border-bottom: 1px solid #333;width:120px">{{$data->no_of_agri_tyre}}</span>
                    ...
                    <label class="inputLabel inputLabelSmall">Total $</label>
                    <span
                      style="display:inline-block;background:none;border:none;border-bottom: 1px solid #333;width:50px">{{$data->order->customer->agri_pricing
                      * $data->no_of_agri_tyre}}</span>
                  </div>
                </tr>

                <tr>
                  <div class="mt-2">
                    <label class="inputLabel" style="margin-top: 10px;width:140px; ">No. Other tires</label>

                    <span
                      style="display:inline-block;background:none;border:none;border-bottom: 1px solid #333;width:120px">{{$data->no_of_other}}</span>
                    ...
                    <label class="inputLabel inputLabelSmall">Total $</label>
                    <span
                      style="display:inline-block;background:none;border:none;border-bottom: 1px solid #333;width:50px">{{$data->order->customer->other
                      * $data->no_of_other}}</span>
                ...
                <tr style="text-align: right;">
                  ...
                  <div class="mt-2 ">
                    <label class="inputLabel inputLabelSmall">Total $</label>
                    @php
                    $totalWithoutTax = $data->order->customer->other * $data->no_of_other +
                    $data->order->customer->agri_pricing * $data->no_of_agri_tyre +
                    $data->order->customer->truck_pricing * $data->no_of_truck_tyre;
                    @endphp
                    <input type="text" name="" value="{{($totalWithoutTax)}}"
                ...
                <tr style="text-align: right;">
                  <div class="mt-2 ">
                    ...
                    <input type="text" name="" value="{{$data->order->customer->tax ?? 0}}%"
                      style="background:none;border:none;border-bottom: 1px solid #333;max-width:55px;margin-right:5em;" />
                  </div>
                </tr>
                ...
                <tr>
                  <div class="mt-2">
                    <label class="inputLabel" style="margin-top: 10px;width:90px; ">Start Weight</label>
              ...
              <tbody>
                <tr>
                  <div class="col-12 col-md-6">
                    <div>
                      ...
                      <p class=" text-uppercase text-center " style="font-size: 0.88rem; line-height: normal">
                ...
                <tr class="">
                  ...
                  <div style="display: inline-flex;min-width:100px;">
                    <input type="text" name="" value="{{Auth::user()->driver_license ?? 'N/A'}}" class="inputField" />
                ...
                <br>
                <tr>
                  <span class="fw-bold " style="font-size: 0.88rem; line-height: normal;margin-top:5px">I certify that
    ...
    <table style="width: 100%">
      <tbody>
        <tr>
          ...
          <div>
            <label class="inputLabel" style="margin-top: 10px; min-width: 160px;">No. of Tires Picked Up:</label>
            <input style="border-bottom: 1px solid #333;min-width:150px" type="number" name="" value="" />
        ...
        <tr>
          ...
          <div>
            <label class="inputLabel" style="margin-top: 10px; min-width: 160px;">removed for reuse:</label>
            <input style="border-bottom: 1px solid #333;min-width:150px" type="number" name="" value="" />
            <label class="inputLabel">passenger tires</label>
              ...
              <td>
                ...
                <tr class="">
                  ...
                  <div style="display: inline-flex;max-width:150px;">
                    <input type="text" name="" value="{{$data->processor_reg_no ?? 'N/A'}}" class="inputField" />
                    <label class="inputLabel">registration number</label>
                  </div>


                  <div style="display: inline-flex;">
                    <input type="text" name="" style="min-width: 200px" class="inputField" />
                ...
                <tr>
                  ...
                  <div style="display: inline-flex;">
                    <input type="text" name="" value="" style="min-width: 60px" class="inputField" />
            ...
            <tbody>
              <td>
                ...
                <tr class="mt-2" style="">
                  ...
                  <div style="display: inline-flex;">
                    <input type="text" name="" value="" style="min-width: 200px" class="inputField" />
                    <label class="inputLabel" style="text-align: center">date and time of pickup</label>
                  </div>
      ...
      <tbody>
        <tr>
          <td>
            <div class="col-6">
              <label class="inputLabel">signature</label>
              <input style="border-bottom: 1px solid #333;width:70%" type="number" name="" value="" class="" />
            </div>
          </td>
