                        ...
                        <table class="table table-borderless table-sm">
                            <tbody>
                                ...
                                <tr>
                                    <div class="d-flex flex-column">
                                        <span class="inputField"
                                            style="display: inline-block;">{{ $data['orderRequest']['company_reg'] }}</span>
                                ...
                                <tr>
                                    <div class="d-flex flex-column">
                                        <input type="text" name=""
                                            value="{{ $data['orderRequest']['company_name'] }}" class="inputField" />
                                    ...
                                    <td style="justify-content:left">
                                        <div style="display: inline-flex;width:200px;">
                                            <span style="display: inline-block;height:20px"
                                                class="inputField">{{ $data['orderRequest']['contact_name'] }}</span>
                                            <label class="inputLabel" style="white-space: nowrap">Contact Name</label>
                                        </div>

                                        <div style="display: inline-flex;width:200px;">
                                            <span style="display: inline-block;height:20px"
                                                class="inputField">{{ $data['orderRequest']['contact_phone_no'] }}</span>
                                ...
                                <tr>
                                    <div class="d-flex flex-column">
                                        <input type="text" name=""
                                            value="{{ $data['orderRequest']['company_Address'] }}" class="inputField" />
                                ...
                                @if (true)
                                    @php
                                        $typesOfPassangerTires = !empty($data['type_of_passenger'])
                                            ? json_decode($data['type_of_passenger'], true)
                                            : [];
                                        $typesOfTruckTires = !empty($data['type_of_truck_tyre'])
                                            ? json_decode($data['type_of_truck_tyre'], true)
                                            : [];
                                        $typesOfAgriTires = !empty($data['type_of_agri_tyre'])
                                            ? json_decode($data['type_of_agri_tyre'], true)
                                            : [];
                                        ...
                                        @foreach ($item as $key => $value)
                                            ...
                                            @php
                                                ...
                                                if ($key == 'lawnmowers_atvmotorcycle') {
                                                    ...
                                                    $eachCharge =
                                                        $data['customerPricing']['lawnmowers_atvmotorcyclewithrim'];
