    ...
    <table>
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>Start Weight</td>
                    <td class="">{{ $data->tdfOrder->start_weight }}</td>
                    <td style="text-align: right;">End Weight</td>
                    <td>{{ $data->tdfOrder->end_weight }}</td>
                </tr>
                <tr>
                    <td></td>
                    <td class=""></td>
                    <td style="text-align: right;">Price Per Ton</td>
                    <td>$ {{ number_format( $data->customerPricing->price_per_ton ?? 0 , 2)}}</td>
                </tr>
                <tr>
                    <td>Bol #</td>
                    <td class=""></td>
