                            ...
                            <td>
                                ...
                                <tr class="">
                                    ...
                                    <div style="display: inline-flex;max-width:150px;">
                                        <input type="text" name=""
                                            value="{{ $data->unfill->reg_no ?? 'N/A' }}" class="inputField" />
                                        <label class="inputLabel">registration number</label>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <div style="display: inline-flex;min-width:100px;">
                                        <input type="text" name="" value="{{$data->unfill->passanger_tires ?? ''}}" class="inputField" />
                                        <label class="inputLabel">no. passenger tires</label>
                                    </div>


                                    <div style="display: inline-flex;">
                                        <input type="text" name="" value="{{$data->unfill->truck_tires ?? ''}}" style="min-width: 60px"
                                            class="inputField" />
                                    ...
                                    <div style="display: inline-flex;margin-left:5px">
                                        <input type="text" name="" value="{{$data->unfill->weight_tire ?? ''}}" style="min-width: 60px;"
                                            class="inputField" />
                                ...
                                <tr>
                                    <td>
                                        <div style="display: inline-block">
                                            <input type="text" name=""
                                                value="512-756-8218" class="inputField" />
                                            <label class="inputLabel" style="white-space: nowrap">Area Code Telephone
                                                Number</label>
                                        </div>
                                ...
                                <tr>
                                    <div class="d-flex flex-column">
                                        <input type="text" name="" value="3345 E. State HWY 29 Burnet, TX 78611" class="inputField" />
                                        <label class="inputLabel">Street Address</label>
                                    </div>
                                </tr>
